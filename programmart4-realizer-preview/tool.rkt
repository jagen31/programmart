...
(preferences:set-default 'programmart4-realizer-preview:visible? #f boolean?)
(preferences:set-default 'programmart4-realizer-preview:percentage 3/5
...
(define (preview-frame-mixin super%)
  (class super%
    ...
    (define preview #f)
    (define menu-item #f)
    (define visible? (preferences:get 'programmart4-realizer-preview:visible?))
    ...
    (define/private (apply-visibility)
      (when split-panel
        ...
        (when visible?
          (define p (exact-percentage (preferences:get 'programmart4-realizer-preview:percentage)))
    ...
    (define/private (toggle-preview)
      ...
      (when (and visible? split-panel)
        ...
        (when (= 2 (length ps))
          (preferences:set 'programmart4-realizer-preview:percentage (exact-percentage (car ps)))))
      (set! visible? (not visible?))
      (preferences:set 'programmart4-realizer-preview:visible? visible?)
      (apply-visibility))
